	...
	return (
		<div>
			<div className="text-center mb-5 py-4">
				<h1 className="fw-bold" data-aos="fade-down">Contact Us</h1>
				<h5 className="text-muted" data-aos="fade-up">We'd love to hear from you</h5>
			</div>

			<div className="container">
			<div className="row row-cols-1 row-cols-md-2 d-flex justify-content-center my-5 ">
			<div className="col-6 text-center" data-aos="fade-right">
