  ...
  useEffect(()=> {
	...
	return (
		<div>
			...
			<h1 className="text-center fw-bold text-uppercase animate__animated animate__pulse animate__delay-2s" data-aos="fade-down">Introducing</h1>
      ...
      <h1 className="text-center fw-bold text-info text-uppercase" data-aos="fade-right">Fly in the sky</h1>
